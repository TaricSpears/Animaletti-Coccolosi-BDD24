 ...
 * public PopulateTherapyButton(final String email, final Stage primaryStage,
 ...
 * CheckBox("Inserisci regime farmacologico settimanale");
 * 
 * // Create login button
 ...
 * checkBoxMatrixWorkout.show(primaryStage, previousTab,
 * Integer.parseInt(idTerapia));
 * }
 * if (checkBox3.isSelected()) {
 * CheckBoxMatrixRegime checkBoxMatrixRegime = new CheckBoxMatrixRegime();
 * checkBoxMatrixRegime.show(primaryStage, previousTab,
 * Integer.parseInt(idTerapia));
 * }
 * });
 * 
 * // Add components to the layout
 * root.getChildren().addAll(title, checkBox1, checkBox2, checkBox3,
 * inserisciButton);
 * 
